...
<div id="landing-page-content-wrapper">
    ...
    <div class="logo-menu-bar-wrapper row">
        <div class="logo">
            <a href="<?php echo $variables['university_base_url']; ?>">
                <img src="<?php echo $variables['path_to_logo']; ?>"></a>
        </div>
        <div class="menu">
            <ul>
        ...
        <div class="svg-wrapper">
            <svg width="1025px" height="537px" viewBox="0 0 1025 537" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                <g id="Page-1" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                    <g id="Artboard2" fill="<?php echo $variables['school_primary_color']; ?>">
    ...
    <div class="panel-first row">
        ...
        <div class="grid-wrapper">
            ...
            <div class="block-2 block">
                ...
                <ul><li>
                        Select between school branded and standard themes
                    </li>
                    <li>
    ...
    <div class="panel-second row">
        ...
        <div class="grid-wrapper">
            ...
            <div class="block-1 block"><p>Take a 1 1/2 minute tour to see what simple steps you can take to build a unique, professional-looking website on your own.</p>
    ...
    <div class="branding_footer row">
        <div class="branding-container">
            <div class="copyright">
                <span class="copyright">Copyright &copy; <?php echo date('Y'); ?> <?php echo $variables['name_of_school']; ?></span>  |
                <a href="<?php echo $variables['site_privacy']; ?>">Privacy</a> |
                <a href="<?php echo $variables['site_access']; ?>">Accessibility</a> |
                <a href="<?php echo $variables['site_digital_access']; ?>">Digital Accessibility</a> |
